...
**This repository is the official repository of the paper, *Custyle: Gaussian Splatting Stylization with Customized Reference via Dynamic Style Score Distillation*.**
